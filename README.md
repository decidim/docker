...
## Cache
The app needs a cache server. This will be a `redis:8-alpine` instance. 
...
| **DECIDIM_APPLICATION_NAME** | — | app | Application name shown in UI and configuration. |
...
| **SMTP_DOMAIN** | — | app, worker | SMTP HELO domain. |
| **SMTP_PORT** | — | app, worker | SMTP port. |
| **SMTP_STARTTLS_AUTO** | `true` | app | Enables STARTTLS automatically. |

| **REDIS_URL** | `redis://redis:6379/0` | app | Redis URL for cache + sessions. |
